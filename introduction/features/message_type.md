...
- URocketMQ 5.x 版本支持指定延时时间后投递消息。
- URocketMQ 4.x 与 5.x 版本均支持固定梯度延迟消息。

### 固定梯度延迟消息

默认配置“1s 5s 10s 30s 1m 2m 3m 4m 5m 6m 7m 8m 9m 10m 20m 30m 1h 2h” 18个级别，每个级别对应不同的延时时间，比如1对应1s，5对应1m，具体如下:
